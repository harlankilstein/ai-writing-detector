...
import { Upload, FileText, AlertCircle, CheckCircle, BarChart3, FileX, Globe, User, LogOut } from 'lucide-react';
...
const AIWritingDetector = () => {
  ...
  const [analysisSource, setAnalysisSource] = useState(''); // 'file' or 'google-doc'
    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.status === 402) {
          // Payment required - trial expired or subscription expired
